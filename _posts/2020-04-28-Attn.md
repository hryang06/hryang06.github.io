...
attention-based decoder가 실질적인 Prediction stage에서 Attention(Attn)을 의미한다. attention-based decoder는 아래 셋 모두 비슷하다.
...
- EP : 7-Conv-vased / ResNet(extrator) + EP-based attention decoder
