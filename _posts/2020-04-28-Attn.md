...
2. alignment factors와 glimpse vectors를 생성하기 위해 sequence of features를 **AN**으로 보낸다.
3. 이때, **FN**을 이용해 glimpse vectors가 reasonable한지 판단하고, AN이 보다 reasonable한 glimpse vectors를 생성할 수 있도록 feedback을 제공한다. 이를 통해, AN은 처리된 이미지에서 target characters의 올바른 영역에 적절하게 attention할 수 있다.
...
![Formula 1](/assets/images/post/attn/formula1.png){: width="80%" height="80%"}
- $$g_t$$ : glimpse vector
...
![Formula 6](/assets/images/post/attn/formula6.png){: width="80%" height="80%"}
...
![Formula 7](/assets/images/post/attn/formula7.png){: width="80%" height="80%"}
...
![Formula 12](/assets/images/post/attn/formula12.png){: width="80%" height="80%"}
- $$K$$ : label class 개수

focussing loss function

![Formula 13](/assets/images/post/attn/formula13.png){: width="80%" height="80%"}
...
- CNN-BLSTM encoder : input image $$I$$를 high level sequece of feautures로 변환한다.
- RNN decoder : 각 target character를 생성한다.
